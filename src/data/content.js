...
export const certifications = [
  {
    ...
    date: '28 May 2026',
    desc: 'Hands-on training in building AI agents and multi-agent systems using LangChain, LangGraph, Hugging Face, RAG pipelines, Vectorless RAG, Model Context Protocol (MCP), Prompt Engineering, Guardrails, and LLM integration.',
    skills: ['LangChain', 'LangGraph', 'Hugging Face', 'RAG Pipelines', 'Vectorless RAG', 'MCP', 'Prompt Engineering', 'Guardrails', 'LLM Integration'],
    tools: ['OpenAI API', 'Groq API', 'Tavily API', 'LangSmith', 'Postman'],
    link: 'https://www.udemy.com/certificate/UC-062a0b20-ce9b-4a5d-b494-d68bd4c6ca8c/',
  },
  {
    title: 'Google AI Agents: Intensive Vibe Coding Course',
